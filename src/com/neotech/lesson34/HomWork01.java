...
public class HomWork01 {
	...
	public static void main(String[] args) throws IOException {
		 ...
		 * print the ArrayList. 2. Read the fifth column (col index 4) and create an
		 * HashSet of Double. Then print the HashSet.
		 * 
		 */

		String filePath = System.getProperty("user.dir") + "/test_data/Homework.xlsx";
		System.out.println("Location of my homework xlsx --> " + filePath);

		// 2nd step: creata stream / connection to the file
		FileInputStream fis = new FileInputStream(filePath);

		// if we open Excel using MS Excel app then we can see the first sheet and then
		// move to
		// others and so on
